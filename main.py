...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        self.button_4 = customtkinter.CTkButton(master=self.frame_left, image=previous_image, text="",
                                                ...
                                                corner_radius=8)
        self.button_4.place(relx=0.5, y=260, anchor=tk.CENTER)

        self.button_5 = customtkinter.CTkButton(master=self.frame_left, image=next_image, text="",
                                                command=self.next, width=60, height=60, border_width=0, corner_radius=8)
        self.button_5.place(relx=0.5, y=330, anchor=tk.CENTER)
    ...
    def play(self):
        ...
        self.music_file = str(song_directory[0][0]) + "/" + str(self.song)
    ...
    def stop(self):
        ...
        self.status_bar.config(text=f'{self.song}\n00:00:00/00:00:00')
